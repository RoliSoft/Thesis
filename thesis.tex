...
\addtocontents{lot}{\protect\clearlist}
\addtocontents{lol}{\protect\clearlist}
...
\setcounter{figure}{199}
\setcounter{table}{199}
\setcounter{listing}{199}
...
\addtocontents{lot}{\protect\resetlist}
\addtocontents{lol}{\protect\resetlist}
...
\subsectionhu{Külső Feltérképezés} \subsectionro{Scanare Externală}
	...
	While the application implements a broad range of protocol scanners as discussed in sections \ref{ssec:icmpping} through \ref{ssec:udpscan}, with an unified interface for task parallelization as discussed in section \ref{ssec:tasks}, as a measure of redundancy, the users are given the choice of using an external scanner for their reconnaissance purposes.
