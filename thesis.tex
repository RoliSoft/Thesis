...
\subsubsection{Implementation Overview}
	...
	Doing so, we end up with an array like \mintinline[style=vs]{js}{["apache", "tomcat"]} for the example CPE name \mintinline{matlab}{cpe:/a:apache:tomcat:4.1.36}.
