...
\subsubsection{Regular Expression Database}
\subsubsectionhu{Reguláris Kifejezés Adatbázis} \subsubsectionro{Baza de Date cu Expresii Regulate}
	...
	\begin{listing}[H]
		...
		\end{minted}
		\caption{Approximate internal representation of the service regular expression database}
		\label{jsrgxdb}
	\end{listing}
